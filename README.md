...
This notebook highlights financial forecasting material that I taught during my time as Director of Quantitative Analysis for the Sustainable Investment Group (SIG) at UCSD. While not all of the material could be preserved, this notebook is representative of the quality and themes of the content I developed and presented. The workflows showcase forecasting methods, data manipulation, and teaching-oriented examples of applied finance. 

### 3. World Series Analysis

An applied project using historical World Series data to explore trends, predictive modeling, and statistical inference in sports analytics. Workflow demonstrates time series analysis, visualization, and longitudinal hypothesis testing for operating decision-making within the MLB
